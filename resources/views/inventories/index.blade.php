            ...
            <table id="dt-products" class="table table-striped table-bordered dts table-sm">
                ...
                @foreach ($inventories as $inventory)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" class="edit-form-data" data-toggle="modal" data-target="#editMdlInventory{{$inventory->id}}">
                                <i class="fas fa-edit"></i>
                            </a> | <form action="{{ route('inventories.destroy', $inventory->id) }}" role="form" method="post" id="createStoreFrm">
                                @method('DELETE')
                                {{ csrf_field() }}
                                <button class="button btn-danger btn-sm" type="submit">
